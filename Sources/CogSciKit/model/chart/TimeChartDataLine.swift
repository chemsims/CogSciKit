...
/// These `y` values are converted to positions using an instance of `LinearAxis`.
///
/// Typically, the range of `x` values are used to find the `x` position, by another instance of `LinearAxis`.
...
/// case applying a logarithm. This transformed value is then passed into the `LinearAxis` to return a position.
///
