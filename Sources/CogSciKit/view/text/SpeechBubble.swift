    ...
    var body: some View {
        Group {
            ...
            TextLinesView(
                ...
                weight: .regular,
                color: .black,
                emphasisColor: CorePalette.orangeAccent
            )
...
struct SpeechBubble_Previews: PreviewProvider {
    ...
    static var previews: some View {
        VStack {
            ...
            SpeechBubble(lines: [.init(content: [.init(content: "this is a test", emphasised: true)])], fontSize: 20).frame(width: 220, height: 200)
        }
    }
}
