    ...
    private var nextButton: some View {
        ZStack {
            NextButton(action: { navigate(next: true) })
                ...
                .accessibilityConditionalHint(showHint: model.nextIsDisabled, hint: "Select correct answer to enable next button")
    ...
    private var progressBar: some View {
        ZStack {
            ...
            ProgressBar(
                ...
                progressColor: CorePalette.Quiz.progressForeground,
...
private extension View {
    ...
    @ViewBuilder
    func quizDebugModifier<T1, T2>(model: QuizViewModel<T1, T2>) -> some View {
        #if DEBUG
    ...
    @ViewBuilder
    func accessibilityConditionalHint(showHint: Bool, hint: String) -> some View {
        if showHint {
